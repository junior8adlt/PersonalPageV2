...
export const greetings = {
  ...
  description:
    'A passionate Frontend Web Developer having an experience of building Cross Platform Web applications with JavaScript / Reactjs / Nodejs / and some other cool libraries and frameworks.',
  resumeLink:
    'https://drive.google.com/file/d/1ymqJ5o25cgGtPNJJyOHwZaD4XfQPlP6u/view?usp=sharing',
};
...
export const skillsSection = {
  ...
  skills: [
    ...
    emoji('⚡ Experience working under the SCRUM mode'),
  ],
...
export const experience = [
...

  {
    ...
    desc: 'Here I worked mostly for multiple projects for a US Clients usin React as a main technology:',
    descBullets: [
  ...
  },
  {
    ...
    desc: 'Here I worked mostly for Commerce projects such as Claro Colombia & Telcel, responsibilities:',
    descBullets: [
      'Structure the frontend part of the site with React.',
      'Integrate the REST API Services with the structure of the site with React.',
      'Develop of reusable components with React.',
  ...
  },
  {
    ...
    desc: 'Here I developed multiple projects for car builders such as Audi, Porsche and Volkswagen, as well as managing the administration and control of the frontend department.',
    descBullets: [
      'Structure the frontend part of the site with React & Vue.',
  ...
  },
  {
    ...
    desc: 'Here I developed a system for the management and administration of the Qatar 2022 Soccer World Cup',
    descBullets: [
  ...
  },
  {
    ...
    desc: 'Here I developed a system for the administration of a garbage collection company, as well as developing a mobile application to rent objects.',
    descBullets: [
